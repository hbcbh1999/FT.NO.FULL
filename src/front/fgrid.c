	...
	INTERFACE	*grid_intfc)
{
	...
	delete_interface(grid_intfc);
            ...
            {
                printf("\n\nStorage after delete_interface in free_grid_intfc\n");
                int totalNum = -1;
	...
	VOLUME_FRAC	*volume_frac)
{
	...
	*/
	...
	make_interface_topology_lists(grid_intfc);
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after make_interface_topology_lists in make_grid_intfc\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "table";
                totalNum = get_number_of_blockName(stdout, blockName);
	...
	set_crx_storage_for_reconstruction(grid_intfc,volume_frac);
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after set_crx_storage_for_reconstruction in make_grid_intfc\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "table";
                totalNum = get_number_of_blockName(stdout, blockName);
	...
	stop_clock("insert_grid_intfc_crossings");
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after insert_grid_intfc_crossings in make_grid_intfc\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "table";
                totalNum = get_number_of_blockName(stdout, blockName);
	...
	stop_clock("set_grid_intfc_components");
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after set_grid_intfc_components in make_grid_intfc\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "table";
                totalNum = get_number_of_blockName(stdout, blockName);
