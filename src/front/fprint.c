        ...
        boolean print_in_binary)
{
	...
	//if (pp_numnodes() > 1)
        ...
        sprintf(dirname,"%s/interface",dirname,right_flush(pp_mynode(),4));
	...
	if (!create_directory(dirname,YES))
	{
        ...
        vtp_interface_plot(dirname,front->interf,print_in_binary,
...
EXPORT  void show_front_output_vtp(
        Front *front,
        char *out_name,
	boolean print_in_binary) 
{   
	...
	show_front_vtp(front,out_name,print_in_binary);	
        #endif 
