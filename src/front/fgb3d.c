	...
	Front     *front)
{
	...
	print_storage("Entering repair_intfc_at_crossings3d","crx_store");
            ...
            {
                printf("\n\nStorage entering repair_intfc_at_crossings3d()\n");
                int totalNum = -1;
	...
	print_storage("After insert_grid_intfc_crossings","crx_store");
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after insert_grid_intfc_crossings()\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "chunk";
                totalNum = get_number_of_blockName(stdout, blockName);
	...
	print_storage("After repair_intfc3d_in_box","crx_store");
            ...
            if (debugging("storage"))
            {
                printf("\n\nStorage after repair_intfc3d_in_box\n");
                int totalNum = -1;
                const char *blockName;
                blockName = "chunk";
                totalNum = get_number_of_blockName(stdout, blockName);
	...
	Front *front)
{
	...
	boolean status;
        ...
        DEBUG_ENTER(repair_intfc3d_in_box);
	...
	if (debugging("set_component"))
        ...
        DEBUG_LEAVE(repair_intfc3d_in_box);
	...
	RECT_BOX	**boxes)
{
	...
	while (i < num_ip)
	{
        ...
        //if(increased_recon_box == YES)
        {
            for (k = 0; k < 3; k++)
            {
                box->bmin[k] = box->bmin[k] - 1;
                box->bmax[k] = box->bmax[k] + 1;
            }
        }
	...
	double **tnor)
{
	...
	*num_sides = 0;
	...
	if (*num_sides > MAX_NULL_SIDE_LOOP) {
	    printf("Stack overflow: *num_sides > MAX_NULL_SIDE_LOOP, where *num_sides = %d.", *num_sides);
	    clean_up(ERROR);
	}
	...
	int *num_sub_tris2)
{
	...
	if (num_sub_list1 > MAX_NULL_SIDE_LOOP) {
            printf("Stack overflow: num_sub_list1 > MAX_NULL_SIDE_LOOP, where num_sub_list1 = %d.", num_sub_list1);
            clean_up(ERROR);
	}

        if (num_sub_list2 > MAX_NULL_SIDE_LOOP) {
            printf("Stack overflow: num_sub_list2 > MAX_NULL_SIDE_LOOP, where num_sub_list2 = %d.", num_sub_list2);
            clean_up(ERROR);
        }
