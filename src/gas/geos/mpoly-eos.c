...
LOCAL	double	MPOLY_internal_energy(Locstate);
LOCAL	double	MPOLY_pressure(Locstate);
LOCAL	double	MPOLY_sound_speed_squared(Locstate);
LOCAL	double	MPOLY_acoustic_impedance_squared(Locstate);
LOCAL	double	MPOLY_specific_internal_energy(Locstate);

	/* SECONDARY AND SUPPORTING THERMODYNAMIC FUNCTIONS */
LOCAL	double	MPOLY_specific_enthalpy(Locstate);
LOCAL	double	MPOLY_temperature(Locstate);
LOCAL	double	MPOLY_entropy(Locstate);
LOCAL	double	MPOLY_adiabatic_gamma(Locstate);
LOCAL	double	MPOLY_gruneisen_gamma(Locstate);
LOCAL	double	MPOLY_fundamental_derivative(Locstate);
LOCAL	double	MPOLY_C_V(Locstate);
LOCAL	double	MPOLY_C_P(Locstate);
LOCAL	double	MPOLY_K_S(Locstate);
LOCAL	double	MPOLY_K_T(Locstate);
LOCAL   double   MPOLY_specific_internal_energy_h_species(Locstate);
LOCAL   double   MPOLY_specific_internal_energy_l_species(Locstate);
...
LOCAL	double	MPOLY_dens_Hugoniot(double,Locstate);
LOCAL	void	MPOLY_state_w_pr_on_Hugoniot(Locstate,double,Locstate,int);
LOCAL	boolean	MPOLY_state_w_mf_sqr_on_Hugoniot(Locstate,double,Locstate,int);

	/* Velocity Related Hugoniot Functions */
LOCAL	double	MPOLY_pr_normal_vel_wave_curve(double,Locstate);

	/* Purely Thermodynamic Adiabatic Wave Curve Functions */
LOCAL	double	MPOLY_dens_rarefaction(double,Locstate);
LOCAL	double	MPOLY_pressure_rarefaction(double,Locstate);
LOCAL	void	MPOLY_state_on_adiabat_with_pr(Locstate,double,Locstate,int);
LOCAL	void	MPOLY_state_on_adiabat_with_dens(Locstate,double,Locstate,int);

	/* General Wave Curve Functions */
LOCAL	double	MPOLY_mass_flux(double,Locstate);
LOCAL	double	MPOLY_mass_flux_squared(double,Locstate);

	/* Functions for the Evaluation of Riemann Solutions */
LOCAL	double	MPOLY_oned_fan_state(double,Locstate,Locstate,Locstate,int,
				     boolean*);

	/* Functions to Compute Riemann Solutions */
LOCAL	double	MPOLY_riemann_wave_curve(Locstate,double);
LOCAL	void	MPOLY_set_state_for_find_mid_state(Locstate,Locstate);
LOCAL	double	MPOLY_eps_for_Godunov(Locstate,double,double);
LOCAL	void	MPOLY_initialize_riemann_solver(Locstate,Locstate,double*,
...
LOCAL	boolean	MPOLY_steady_state_wave_curve(double,double,double*,Locstate);
LOCAL	double	MPOLY_pressure_at_sonic_point(double,Locstate);
LOCAL	boolean	MPOLY_pr_at_max_turn_angle(double*,double,Locstate);
LOCAL	double	MPOLY_state_in_prandtl_meyer_wave(double,double,Locstate,double,
						  Locstate,Locstate,int);

#if defined(COMBUSTION_CODE)
	/* DETONATION SPECIFIC UTILITY FUNCTIONS */
LOCAL	double	MPOLY_CJ_state(Locstate,int,Locstate,int,int);
LOCAL	void	MPOLY_progress_state(double,Locstate,Locstate,double);
LOCAL	void	MPOLY_fprint_combustion_params(FILE*,Gas_param*);
#endif /* defined(COMBUSTION_CODE) */

	/* METHOD OF CHARACTERISTIC FUNCTIONS FOR W_SPEED */
LOCAL	void	MPOLY_neumann_riem_inv_moc(double*,Locstate,double,double,Locstate,
	                                   SIDE,Locstate,double,double*,Front*);
LOCAL	void	MPOLY_shock_ahead_state_riem_inv_moc(double*,Locstate,Locstate,
	                                             Locstate,Locstate,
	                                             Locstate,double,double,
	                                             double,double,double*,double*,
						     int,double,Front*);
LOCAL	boolean	MPOLY_shock_moc_plus_rh(double*,Locstate,Locstate,Locstate,
...
LOCAL	double	MPOLY_RT_RS_f(double,Locstate,double,double,double);
LOCAL	void	MPOLY_RT_single_mode_perturbation_state(Locstate,double*,double,
							Locstate,double,double,
							MODE*,double);
LOCAL	void	MPOLY_KH_single_mode_state(Locstate,double*,double,Locstate,
					   double,double,double,MODE*);
LOCAL	void	MPOLY_compute_isothermal_stratified_state(Locstate,double,double,
							  Locstate);
LOCAL	void	MPOLY_compute_isentropic_stratified_state(Locstate,double,double,
							  Locstate);
LOCAL	void	set_eos_function_hooks(EOS*);

LOCAL	double	*Vec_Gas_Gamma(Vec_Gas*,int,int);
LOCAL	double	Gamma(Locstate);
LOCAL	double	Mu(Locstate);
LOCAL	double	Coef1(Locstate);
LOCAL	double	Coef2(Locstate);
LOCAL	double	Coef3(Locstate);
LOCAL	double	Coef4(Locstate);
LOCAL	double	Coef5(Locstate);
LOCAL	double	Coef6(Locstate);
LOCAL	double	Coef7(Locstate);
LOCAL	double	Coef8(Locstate);
LOCAL	double	molecular_weight(Locstate);
LOCAL	double	R(Locstate);
...
LOCAL	boolean	mpoly_fS(double,double*,POINTER);
	...
	EOS *eos)
{
	...
	eos->_K_S = MPOLY_K_S;
	eos->_K_T = MPOLY_K_T;
        eos->_specific_internal_energy_h_species = MPOLY_specific_internal_energy_h_species;
        eos->_specific_internal_energy_l_species = MPOLY_specific_internal_energy_l_species;
...
LOCAL	double	MPOLY_internal_energy(
	Locstate state)
{
	double gam;
...
LOCAL	double	MPOLY_sound_speed_squared(
	Locstate state)
{
	double c2;
...
LOCAL	double	MPOLY_acoustic_impedance_squared(
	Locstate state)
{
	double i2;
	if (state_type(state) == VGAS_STATE)
...
LOCAL	double	MPOLY_specific_internal_energy(
	Locstate state)
{
...
LOCAL	double	MPOLY_specific_enthalpy(
	Locstate state)
{
...
LOCAL	double	MPOLY_temperature(
	Locstate state)
{
...
LOCAL	double	MPOLY_adiabatic_gamma(
	Locstate state)
{
	return Gamma(state);
...
LOCAL	double	MPOLY_gruneisen_gamma(
	Locstate state)
{
...
LOCAL	double	MPOLY_fundamental_derivative(
	Locstate state)
{
	...
	int     vsize)
{
	...
	int     k;
	double	*gm = Vec_Gas_Gamma(vst,offset,vsize);
...
LOCAL	double	MPOLY_dens_Hugoniot(
	double p1,
	Locstate st0)
{
	double	p0, c4;
...
LOCAL	boolean	MPOLY_state_w_mf_sqr_on_Hugoniot(
	Locstate st0,
	double m2,
	Locstate st1,
	int stype1)
...
LOCAL	double	MPOLY_pr_normal_vel_wave_curve(
...
LOCAL	double	MPOLY_dens_rarefaction(
	double p1,
	Locstate st0)
{
...
LOCAL	double	MPOLY_pressure_rarefaction(
	double rho1,
	Locstate st0)
{
...
LOCAL	double	MPOLY_mass_flux_squared(
	double p,
	Locstate st0)
{
	double p0, rho0;
...
/*ARGSUSED*/
LOCAL	double	MPOLY_oned_fan_state(
	double    w,
	Locstate sta,
	Locstate stb,
	Locstate stm,
...
LOCAL	double	MPOLY_riemann_wave_curve(
	Locstate st0,
	double pstar)
{
...
/*ARGSUSED*/
LOCAL	double	MPOLY_eps_for_Godunov(
	Locstate state,
	double pstar,
	double r_eps)
{
...
LOCAL	boolean	MPOLY_steady_state_wave_curve(
	double p1,
	double M0sq,
	double *theta,
	Locstate st0)
...
LOCAL	double	MPOLY_pressure_at_sonic_point(
	double M0sq,
	Locstate st0)
{
	double x;
...
LOCAL	boolean	MPOLY_pr_at_max_turn_angle(
	double *prm,
...
/*ARGSUSED*/
LOCAL	double	MPOLY_state_in_prandtl_meyer_wave(
	double w,
	double A_a,
	Locstate sta,
	double A_b,
...
LOCAL	boolean	MPOLY_shock_moc_plus_rh(
	double     *pt,
	Locstate  sta,
	Locstate  stm,
	Locstate  stb,
...
LOCAL	void	MPOLY_fprint_EOS_params(
	...
	Gas_param *params)
{
	double	*gam = ((MPOLY_EOS *) params->eos)->_gamma;
	double	*M = ((MPOLY_EOS *) params->eos)->_M;
	double	R = ((MPOLY_EOS *) params->eos)->R;
...
LOCAL	boolean	mpoly_fS(double x, double *fans, POINTER prm)
{
	double c, rr, v;
...
LOCAL   double   MPOLY_specific_internal_energy_h_species(
        Locstate state)
{

        double   *gam = gamma(state);
        return pressure(state)/((gam[1]-1.0)*Dens(state));
}       /* end MPOLY_specific_internal_energy_h_species */

LOCAL   double   MPOLY_specific_internal_energy_l_species(
        Locstate state)
{

        double   *gam = gamma(state);
        return pressure(state)/((gam[0]-1.0)*Dens(state));
}       /* end MPOLY_specific_internal_energy_l_species */
