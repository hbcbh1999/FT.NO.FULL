...
Enter the remapping (Jacobian) converting the physical coordinate system to the
	cartesian computational coordinate system.  The choices are
		...
		Cylindrical Geometry (c)
			Type Choice Here: I
Enter the computational limits in the x direction, XL, XU: 0 2
Enter the computational limits in the y direction, YL, YU: 0 4
Enter the numbers of grid intervals of the
	computational grid in the x & y directions: 256 512
...
Enter limits on real time (max time), mesh time (max timesteps), an optional
	...
	= inf 2147483647 0 constant): 40 9382 0
...
Enter maximum number of time step modifications allowed
	during a propagation step (default = 50): 100
...
Enter the coordinates of upper corner
	of the initial view box (dflt = 1 10): 2 4
Enter the velocity of the view box (dflt = 0 0): 
Specify the number of pixels in the x and y directions (dflt 60 600): 300 600
...
Enter choice: /nfs/user02/linli/FronTier/src/gas/out/ptest.r
Enter the time step at which to find the interface data: 9362
...
Do you wish to modify the interface on restart (dflt = no): n
