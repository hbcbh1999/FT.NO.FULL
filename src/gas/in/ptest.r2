...
Enter limits on real time (max time), mesh time (max timesteps), an optional
	...
	= inf 2147483647 0 constant): 40 5257 0
...
Enter choice: /nfs/user02/linli/FronTier/src/gas/out/ptest.r2
Enter the time step at which to find the interface data: 5247
