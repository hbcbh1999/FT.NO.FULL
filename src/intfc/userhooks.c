	...
	POINTER		*ncad)
{
	...
	(*i_user_interface(nintfc)._reconstruct_interface_pointers)(nintfc,otbl,
								    ocad,ncad);
	/* i_reconstruct_interface_pointers called */
	...
	INTERFACE	*intfc)
{
	...
	return (*i_user_interface(intfc)._make_interface_topology_lists)(intfc); /* make_tri_comp_lists */
