...
static	double pressure(Locstate);
static	double gruneisen_gamma(Locstate);
	...
	int n)
{
      ...
      static double *p;
      Locstate *state;
      TVD_PARAMS *TVD_params = (TVD_PARAMS*)scheme_params;
      double gamma, einf;

      gamma = TVD_params->gamma;
      einf = TVD_params->einf;
      ...
      lambda = TVD_params->lambda;
      beta = TVD_params->beta;
